...
class Ui_MainWindow:
    def setupUi(self, MainWindow):
        ...
        # Top Bar
        self.top_bar = TopBar(parent=self.centralwidget, title="Welcome back!")
        ...
        self.verticalLayout.addLayout(self.horizontal_container)
    ...
    def add_section_header(self, text):
        """Helper to add a stylized section title."""
    ...
    def create_big_button(self, text, icon_name, style):
        """Helper to create a large dashboard button."""

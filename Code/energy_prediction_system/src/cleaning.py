...
def energy (pasta_energy, pasta_saida= None):
    for nomefich in sorted(os.listdir(pasta_energy)):
        if nomefich.endswith(".csv"):
            ...
            # em 2020 e 2021 o horário está de 1h em 1h; 2022 tem de 1h em 1h e de 15min em 15min; o resto é de 15min em 15min
            print ("###########")
...
def outliers_treatment(df):
    ...
    limites_fisicos = {
        ...
        't2m': (-40, 55), 'skt': (-40, 55), 'd2m': (-40, 55),
        'stl1': (-40, 65),
        # Wind: 0-250 km/h- 69.4 m/s
        'u10': (0, 69.4), 'v10': (0, 69.4),
    ...
    if len(diffs.unique()) == 1 and diffs.iloc[0] == pd.Timedelta(minutes=15):
        ...
        while i < len(df):
            ...
            if len(indices_hora) > 1:
                ...
                cols_to_average = [col for col in df.columns 
...
if __name__ == "__main__":
    ...
    caminho_energy_corrigido = "/Users/beatrizfernandes/Desktop/PIACD/dados_PIACD/energy_corrigido"
    energy(caminho_energy, pasta_saida=caminho_energy_corrigido)

    caminho_weather_corrigido = "/Users/beatrizfernandes/Desktop/PIACD/dados_PIACD/weather_corrigido"

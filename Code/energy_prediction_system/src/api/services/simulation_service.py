...
BASE_TEMPLATES = {
    # ============ DAILY ============
    "daily_average": {
        "t2m": 20.0, "skt": 22.0, "tp": 0.0, "ssrd": 2000000.0,
        "sp": 101325.0, "u10": 3.0, "v10": 2.0, "d2m": 10.0,
        "stl1": 21.0, "strd": 1500000.0, "swvl1": 0.35
    },
    "daily_rainy": {
        "t2m": 15.0, "skt": 16.0, "tp": 25.0, "ssrd": 500000.0,
        "sp": 100500.0, "u10": 8.0, "v10": 6.0, "d2m": 14.0,
        "stl1": 15.0, "strd": 1200000.0, "swvl1": 0.65
    },
    "daily_storm": {
        "t2m": 10.0, "skt": 11.0, "tp": 45.0, "ssrd": 200000.0,
        "sp": 98000.0, "u10": -30.0, "v10": -25.0, "d2m": 9.0,
        "stl1": 10.0, "strd": 800000.0, "swvl1": 0.85
    },
    "daily_heatwave": {
        "t2m": 42.0, "skt": 48.0, "tp": 0.0, "ssrd": 3500000.0,
        "sp": 102000.0, "u10": 2.0, "v10": 1.0, "d2m": 18.0,
        "stl1": 45.0, "strd": 2500000.0, "swvl1": 0.10
    },
    # ============ HOURLY ============
    "hourly_average": {
        "t2m": 18.0, "skt": 20.0, "tp": 0.0, "ssrd": 250.0,
        "sp": 101325.0, "u10": 3.0, "v10": 2.0, "d2m": 9.0,
        "stl1": 19.0, "strd": 200.0, "swvl1": 0.35
    },
    "hourly_rainy": {
        "t2m": 13.0, "skt": 14.0, "tp": 5.0, "ssrd": 50.0,
        "sp": 100500.0, "u10": 8.0, "v10": 6.0, "d2m": 12.0,
        "stl1": 13.0, "strd": 100.0, "swvl1": 0.65
    },
    "hourly_storm": {
        "t2m": 9.0, "skt": 10.0, "tp": 12.0, "ssrd": 20.0,
        "sp": 98000.0, "u10": -35.0, "v10": -30.0, "d2m": 8.0,
        "stl1": 9.0, "strd": 50.0, "swvl1": 0.85
    },
    "hourly_heatwave": {
        "t2m": 45.0, "skt": 50.0, "tp": 0.0, "ssrd": 400.0,
        "sp": 102000.0, "u10": 2.0, "v10": 1.0, "d2m": 20.0,
        "stl1": 47.0, "strd": 350.0, "swvl1": 0.10
    },
}
...
class SimulationService:
    ...
    @staticmethod
    def get_active_model(db: Session, frequency: str) -> Optional[Model]:
        """Obtém o modelo ativo para uma frequência"""
    ...
    @staticmethod
    def get_template(frequency: str, condition: str,
        ...
        if template_key not in TEMPLATES:
            raise ValueError(
                ...
                f"Opções disponíveis: {sorted(TEMPLATES.keys())}"
            )
    ...
    def validate_overrides(overrides: Dict[str, float]) -> List[str]:
        ...
        errors = []
        units = {
            "t2m": "°C", "skt": "°C", "d2m": "°C", "stl1": "°C",
            "u10": "m/s", "v10": "m/s", "tp": "mm", "ssrd": "J/m²"
        }
        for feature, value in overrides.items():
            if feature in PHYSICAL_LIMITS:
                ...
                if value < min_val or value > max_val:
                    ...
                    errors.append(
                        f"'{feature}' deve estar entre {min_val} e {max_val} {unit}, "
                        f"recebeu {value}")
        return errors
    ...
    def run_simulation(
        ...
        if not active_model:
            raise ValueError(
                "Nenhum modelo ativo encontrado. Ative um modelo primeiro.")
        ...
        base_features = SimulationService.get_template(
        ...
        if overrides:
            ...
            features = SimulationService.apply_overrides(
        ...
        if original_dataset_type == "pca":
            full_template = SimulationService.get_template(
                frequency, template_name, "full")
            if overrides:
            ...
            logger.info(
                "PCA Flow: usando template 'full' com 117 features para PCA")
        else:
        ...
        if active_model.top2_drivers:
            top_drivers = [d.strip()
                           for d in active_model.top2_drivers.split(",")]
        else:
